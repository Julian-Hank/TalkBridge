...
fun TalkBridgeApp(navController: NavHostController = rememberNavController()) {
    val app = LocalContext.current.applicationContext as TalkBridgeApplication
    val isOnline by app.container.connectivityObserver.isOnline
        ...
        navigationIcon = {
            if (canNavigateBack) {
                ...
                IconButton(onClick = openSettings ) {
                    Icon(
                        imageVector = Icons.Default.MoreVert, //Icons.Default.Settings
