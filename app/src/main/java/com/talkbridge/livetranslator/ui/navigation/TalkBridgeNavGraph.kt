...
import com.talkbridge.livetranslator.ui.common.OfflineBanner
import com.talkbridge.livetranslator.ui.connect.ConnectDestination
import com.talkbridge.livetranslator.ui.connect.ConnectScreen
import com.talkbridge.livetranslator.ui.connect.ConnectViewModel
import com.talkbridge.livetranslator.ui.download.ModelDownLoadDestination
import com.talkbridge.livetranslator.ui.download.ModelDownLoadScreen
...
private val routesRequiringNetwork = setOf(
...
fun TalkBridgeNavHost(
    ...
    val showOfflineBanner = !isOnline && route in routesRequiringNetwork
    ...
    Column {
        NavHost(
            ...
            composable(route = HomeDestination.route) {
                ...
                HomeScreen(
                    ...
                    openConnectScreen = { navController.navigate(ConnectDestination.route) }
                )
            }
            composable(
                ...
                arguments = listOf(
                    ...
                    navArgument(LanguageSelectDestination.callerRouteArg) {
                        type = NavType.StringType
                    }
                )
            ) { backStackEntry ->
                ...
                when (callerRoute) {
                    HomeDestination.route -> {
                        ...
                        val recentLanguages =
                            homeViewModel.homeUiState.collectAsState().value.recentLanguages
                    ...
                    TranslateDestination.route -> {
                        ...
                        val recentLanguages =
                            translateViewModel.translateUiState.collectAsState().value.recentLanguages
                    ...
                    TranscribeDestination.route -> {
                        ...
                        val recentLanguages =
                            transcribeViewModel.transcribeUiState.collectAsState().value.recentLanguages
            ...
            composable(route = ModelDownLoadDestination.route) {
                ModelDownLoadScreen(
                    onBackButtonClick = { navController.navigateUp() }
                )
            }
            composable(route = ConnectDestination.route) {
        ...
        OfflineBanner(
            ...
            onClick = { navController.navigate(ModelDownLoadDestination.route) }
        )
    }
}